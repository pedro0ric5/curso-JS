...
// A primeira fruta está na posição [0], a terceira em [2].
...
// O loop deve começar em i = 0.
console.log("\nLista de frutas:");
for (let i = 0; i < frutas.length; i++) {
  console.log(frutas[i]);
}

// Outra forma de iterar usando 'forEach'
// Uma forma mais limpa de percorrer o array.
